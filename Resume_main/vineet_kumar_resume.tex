...
\begin{rSubsection}{INRO}{December 2014 - present}{Senior developer}{Montreal,
  QC, Canada}
\item Built a new matrix calculator (in \textbf{Python}) for Emme (\href{http://bit.ly/1N5geA8}{\em{http://bit.ly/1N5geA8}})
\begin{lsubSubsection} 
\item Achieved 1.5x to 30x speedup depending on expression details and hardware
  resources.
...
\end{lsubSubsection}
\item Building GUI for CityPhi using QT and OpenGL.
\end{rSubsection}
...
\item Delivered the winning pitch to get selected as one of the 20 startups
