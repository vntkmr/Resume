...
\smallskip
\begin{lSubsection}
 \item \textbf{M.Sc}, \textbf{McGill University} with research in \textbf{Compilers \& Program Analysis} under \textbf{Prof. Laurie Hendren}. 
 %and assistance by \textbf{\xten team at IBM Thomas J. Watson Research Center}
 \item 3 years of industry experience with \textbf{Infosys Technologies} in deployment \textbf{performance management for large-scale systems} and development(in C).
 ...
 \item Experience in all areas of static Compilers including program analysis and transformations, compiling dynamic languages and design of new languages.
...
C, Java, JastAdd, Flex, Bison, Beaver, \matlab, \xten      \smallskip\\}}}}}[0.541cm]%bad hack but works
...
%------------------------------------------------
\marginnote{{\textmd{\textsl{\scriptsize{\hrule 
Management, Software development, Software engineering, SEO, Java, HP LoadRunner        \smallskip\\}}}}}[-0cm]
...
\item Conducted several seminars on Open Solaris in SASTRA and nearby Colleges.
\end{rSubsection}
\end{rSection}
...
\item Vineet Kumar and Laurie Hendren. First steps to compiling \matlab to \textsc{X10}. Technical Report SABLE-TR-2013-1, School of Computer Science, McGill University, Mar. 2013.
