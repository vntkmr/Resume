...
\item Wrote a \textbf{new compiler and memory management system} for Emme's
        matrix calculator language. 
\begin{lsubSubsection} 
\item Achieved \textbf{up to 30x faster}
        performance. Efficient even for computations on \textbf{large
...
\item Designed and built data analytics tools for public transit data.
\begin{lsubSubsection}
...
%        (C++ and Python)
\item Designed and built data import backend and API for CityPhi.
\begin{lsubSubsection}
