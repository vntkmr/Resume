...
\item \textbf{Nearly 7 years of relevant experience} in software design and
...
\item Process inputs to the API and generate code (Emme macros) used as input
	for Emme's Fortran backend. The API also executes the Fortran backend
	and captures and parses the output for logging. 
\end{lsubSubsection}
