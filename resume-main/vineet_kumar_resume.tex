...
\item \textbf{Relocating to Toronto}, available from August.
...
\item Designed and developed \textbf{data analytics tools for public transit
        data}.
\begin{lsubSubsection}
\item These tools enabled our clients to visually analyze and query things like
...
\item Wrote \textbf{\mixtenx: a \matlab to \xten (programming language) compiler for
        high-performance}, under \textbf{Prof. Laurie Hendren's} supervision.
\item Designed a new analysis algorithm to identify and safely typecast double
        values to ints.
